...
$pdf->MultiCell(40, 40, $txt, 0, 'L', 1, 2, 28, 57, true);

$pdf->setCellPaddings(2, 4, 6, 8);
$txt = ($lot_no == null ? "" : $lot_no);
$pdf->MultiCell(40, 40, $txt, 0, 'L', 1, 2, 56, 57, true);

$pdf->setCellPaddings(2, 4, 6, 8);
$txt = ($tax_dec_no == null ? "88-12345" : $tax_dec_no);
$pdf->MultiCell(40, 40, $txt, 0, 'L', 1, 2, 72, 57, true);

$pdf->setCellPaddings(2, 4, 6, 8);
$txt = ($av_land == null ? "88-12345" : $av_land);
$pdf->MultiCell(40, 40, $txt, 0, 'L', 1, 2, 91, 57, true);

$pdf->setCellPaddings(2, 4, 6, 8);
$txt = ($av_improvement == null ? "" : $av_improvement);
$pdf->MultiCell(40, 40, $txt, 0, 'L', 1, 2, 106, 57, true);
