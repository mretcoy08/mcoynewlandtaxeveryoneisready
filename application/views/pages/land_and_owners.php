    ...
    <div class="modal-content">
      ...
      <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    <label for="" class="bmb-label-floating">Last Paid Year</label>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="number" class = "form-control new_input money" name = "assessed_value" id = "assessed_value" required>
                </div>
            </div>
